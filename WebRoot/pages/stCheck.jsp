...
<%
	...
	if (!isAdmin)
	{
		Purview = jdb.getIntBySql(0, "select top 1 Purview from ObjRight where ObjType=10 and ObjParam='stCheck' and GroupID in (" +
...
<style id="css_288" type="text/css">
.pcbody{
...
var sys = {EName:"<%=user.EMemberName%>", CName:"<%=user.CMemberName%>", PhotoID:<%=user.PhotoID%>, PageName:"stCheck", Role:<%=Purview%>};
var book;
