...
%>
<%
	String CodeName="deanEvaluation";
	...
	if (!isAdmin)
	{
		Purview = jdb.getIntBySql(0, "select top 1 Purview from ObjRight where ObjType=10 and ObjParam='deanEvaluation' and GroupID in (" +
			user.MemberGroupIDs + ") order by Purview desc");
	}
	SysApp sysApp = new SysApp(jdb);
//@@##210:服务器启动代码(归档用注释,切勿删改)
//
...
<style id="css_274" type="text/css">
.pcbody{
...
var sys = {EName:"<%=user.EMemberName%>", CName:"<%=user.CMemberName%>", PhotoID:<%=user.PhotoID%>, PageName:"deanEvaluation", Role:<%=Purview%>};
var book;
