...
<%
	...
	if (!isAdmin)
	{
		Purview = jdb.getIntBySql(0, "select top 1 Purview from ObjRight where ObjType=10 and ObjParam='dean' and GroupID in (" +
...
<style id="css_260" type="text/css">
.pcbody{
...
background-size:100% 100%;
	...
	<script type="text/javascript" src="chapters.json?id=3"></script>
	<script type="text/javascript" src="local.js"></script>
<script type="text/javascript">
var sys = {EName:"<%=user.EMemberName%>", CName:"<%=user.CMemberName%>", PhotoID:<%=user.PhotoID%>, PageName:"dean", Role:<%=Purview%>};
var book;
