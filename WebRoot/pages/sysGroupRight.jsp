...
var sys = {EName:"<%=user.EMemberName%>", CName:"<%=user.CMemberName%>", PhotoID:<%=user.PhotoID%>, PageName:"sysGroupRight", Role:<%=Purview%>};
var book;
...
//		 	var o = grid.TitleBar("Waiting...");
			var o = book.setDocTop("加载中...", "Filter", "");
		 	...
		 	var jsp ="../fvs/WorkGroup_list_select.jsp"; 
	...
	function ClickGroup(obj, item)
	{
		if (item.ID != undefined)
		 	$.get("../fvs/ObjRight_view.jsp", {GetGridData:1, ObjType:10, GroupID: item.ID}, GroupRightOK);
	}
